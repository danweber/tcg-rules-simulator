...
export class SolidEffectLoop {
    ...
    evolve_choices?: false | Array<[CardLocation, CardLocation | Instance, CardLocation | Instance | undefined, 'evo' | 'fusion' | 'burst', number?]>;
    ...
    step(): (false | SubEffect[]) {
                ...
                if (!atomic.per_unit_test) {
                    ...
                    if (previous_atomic.events_to_do)
                        for (let se of previous_atomic.events_to_do) {
                            ...
                            console.error(1313, "p x", se.paid, x);
                        }
                }
                console.error(1315, "x", x);
                this.n_repeat = x;
        ...
        if (this.s == FakeStep.ASK_TARGET2) {
            ...
            let mon: Instance = this.effect.source.get_instance();
            if (3 < 4 || !w.td2 || w.game_event !== GameEvent.EVOSOURCE_MOVE) {
                this.s = FakeStep.ASSIGN_TARGET_SUBS;
                return false;
            }
            ...
            let potential_targets = this.game.find_target(w.td2, w.game_event, this.effect.source!, this, Location.SECURITY);
        ...
        if (weirdo.game_event == GameEvent.DELETE) {
            ...
            if (weirdo.status_condition) {
                ...
                if (target && weirdo.td.conjunction != Conjunction.PLAYER) {
                    ...
                    //console.error(2183, weirdo.td.targets);
            ...
            let pl = game.get_n_player(p);
            // todo, set up a seed for testing
            pl.shuffle("", 1);
            return true;
            ...
            // this is ordered differently than the others
            let i:Instance = weirdo.chosen_target2;            
            let recipient: Instance = target;
           let c = i.top();
            ...
            console.error(2536, weirdo.td2?.raw_text);
