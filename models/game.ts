            ...
            if (!sel) {
                ...
                while (n > 0) {
                    ...
                    if (eff.chosen_target && eff.chosen_target.kind === "Instance" && eff.chosen_target.top()) {
                        ...
                        console.error(1489, eff.chosen_target);
                        return [eff.chosen_target];
                    }
                }
                console.error("no prior found, should check trigger clause");
...
//                        ret.push(se);
                        ...
                        if (Instance.one_effect_matchup(kind, se, e, new SpecialCard(cl), p_number, this, cl)) {
                            console.error("1709, GOT A MATCH!!!");
                            ret.push(se);
