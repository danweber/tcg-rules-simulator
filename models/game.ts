...
import { Conjunction, SpecialCard, TargetDesc, TargetSource, fSpecialPlayer } from './target';
...
export class Game {
    ...
    evolve(p: Player, cl: CardLocation, onto: Instance, onto2: Instance | undefined, cost?: number) {
    ...
    find_target(t: TargetDesc, ge: GameEvent, s: TargetSource, sel: SolidEffectLoop | false,
        ...
        if ([
            ...
            if (t.raw_text.match(/token/i)) {
                ...
                to_search.push(...p.trash.map((c, i) => new CardLocation(this, p.player_num, Location.TRASH, i)));
