...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [
            ...
            { "name": "WhenEvo$ebnf$2$string$1", "symbols": [{ "literal": " " }, { "literal": "D" }, { "literal": "N" }, { "literal": "A" }], "postprocess": function joiner(d) { return d.join(''); } },
            ...
            { "name": "WhenEvo$ebnf$3", "symbols": [{ "literal": "s" }], "postprocess": id },
            { "name": "WhenEvo$ebnf$3", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "WhenEvo$string$2", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "WhenEvo", "symbols": ["Target", "WhenEvo$ebnf$1", "WhenEvo$ebnf$2", "WhenEvo$string$1", "WhenEvo$ebnf$3", "WhenEvo$string$2", "Target"], "postprocess": function (d) { return { raw_text: gv(d), event: "EVOLVE", before: d[0], after: d[6], dna: !!d[2] }; } },
            ...
            { "name": "WhenPlay$string$1", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "s" }, { "literal": " " }, { "literal": "p" }, { "literal": "l" }, { "literal": "a" }, { "literal": "y" }, { "literal": "e" }, { "literal": "d" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "WhenPlay", "symbols": ["Target", "WhenPlay$string$1"], "postprocess": function (d) {
                    return { raw_text: gv(d), event: "PLAY", target: d[0] };
                } },
            ...
            { "name": "UnusedReduction$string$1", "symbols": [{ "literal": "r" }, { "literal": "e" }, { "literal": "d" }, { "literal": "u" }, { "literal": "c" }, { "literal": "e" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$1$string$1", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$1", "symbols": ["UnusedReduction$ebnf$1$string$1"], "postprocess": id },
            { "name": "UnusedReduction$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "UnusedReduction$ebnf$2$string$1", "symbols": [{ "literal": "i" }, { "literal": "t" }, { "literal": "s" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$2", "symbols": ["UnusedReduction$ebnf$2$string$1"], "postprocess": id },
            { "name": "UnusedReduction$ebnf$2", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "UnusedReduction$ebnf$3$subexpression$1$string$1", "symbols": [{ "literal": "u" }, { "literal": "s" }, { "literal": "e" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$3$subexpression$1", "symbols": ["UnusedReduction$ebnf$3$subexpression$1$string$1"] },
            { "name": "UnusedReduction$ebnf$3$subexpression$1$string$2", "symbols": [{ "literal": "m" }, { "literal": "e" }, { "literal": "m" }, { "literal": "o" }, { "literal": "r" }, { "literal": "y" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$3$subexpression$1", "symbols": ["UnusedReduction$ebnf$3$subexpression$1$string$2"] },
            { "name": "UnusedReduction$ebnf$3$subexpression$1$string$3", "symbols": [{ "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$3$subexpression$1", "symbols": ["UnusedReduction$ebnf$3$subexpression$1$string$3"] },
            { "name": "UnusedReduction$ebnf$3$subexpression$1$string$4", "symbols": [{ "literal": "p" }, { "literal": "l" }, { "literal": "a" }, { "literal": "y" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$3$subexpression$1", "symbols": ["UnusedReduction$ebnf$3$subexpression$1$string$4"] },
            { "name": "UnusedReduction$ebnf$3", "symbols": ["UnusedReduction$ebnf$3$subexpression$1"], "postprocess": id },
            { "name": "UnusedReduction$ebnf$3", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "UnusedReduction$ebnf$4", "symbols": [{ "literal": " " }], "postprocess": id },
            { "name": "UnusedReduction$ebnf$4", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "UnusedReduction$string$2", "symbols": [{ "literal": "c" }, { "literal": "o" }, { "literal": "s" }, { "literal": "t" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$5$string$1", "symbols": [{ "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction$ebnf$5", "symbols": ["UnusedReduction$ebnf$5$string$1"], "postprocess": id },
            { "name": "UnusedReduction$ebnf$5", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "UnusedReduction$string$3", "symbols": [{ "literal": " " }, { "literal": "b" }, { "literal": "y" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "UnusedReduction", "symbols": ["UnusedReduction$string$1", "UnusedReduction$ebnf$1", "UnusedReduction$ebnf$2", "UnusedReduction$ebnf$3", "UnusedReduction$ebnf$4", "UnusedReduction$string$2", "UnusedReduction$ebnf$5", "UnusedReduction$string$3", "Number"] },
            ...
            { "name": "EffSentence$ebnf$5", "symbols": [{ "literal": "." }], "postprocess": id },
            { "name": "EffSentence$ebnf$5", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence$ebnf$6", "symbols": ["ExtraSentence"], "postprocess": id },
            { "name": "EffSentence$ebnf$6", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["EffSentence$ebnf$1", "EffSentence$ebnf$2", "EffSentence$ebnf$3", "EffSentence$ebnf$4", "EffSentence$subexpression$1", "EffSentence$ebnf$5", "EffSentence$ebnf$6"], "postprocess": function (d, l) {
                    ...
                    return { raw_text: gv(d), when_s: tgv(d[1]), if: tgv(d[2]), cost: tgv(d[3]), type: 'EffSentence', effect: d[4][0], extra: d[6] };
                } },
            { "name": "EffSentence$ebnf$7", "symbols": [{ "literal": "," }], "postprocess": id },
            { "name": "EffSentence$ebnf$7", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["Cost", "EffSentence$ebnf$7"] },
            ...
            { "name": "Declarative$subexpression$1", "symbols": ["Action"] },
            { "name": "Declarative", "symbols": ["Declarative$ebnf$1", "MultiTarget", { "literal": " " }, "Declarative$subexpression$1", { "literal": " " }, "Duration"] },
            ...
            { "name": "YouDeclare", "symbols": ["YouDeclare$subexpression$1", "YouDeclare$ebnf$1", "Action"], "postprocess": function (d, l) { return { raw_text: gv(d), optional: !!d[1], type: d[2].type, action: d[2].action, action_args: d[2].action_args, effect: d[0] }; } },
            ...
            { "name": "Duration$string$3", "symbols": [{ "literal": "u" }, { "literal": "n" }, { "literal": "t" }, { "literal": "i" }, { "literal": "l" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "o" }, { "literal": "p" }, { "literal": "p" }, { "literal": "o" }, { "literal": "n" }, { "literal": "e" }, { "literal": "n" }, { "literal": "t" }, { "literal": "'" }, { "literal": "s" }, { "literal": " " }, { "literal": "t" }, { "literal": "u" }, { "literal": "r" }, { "literal": "n" }, { "literal": " " }, { "literal": "e" }, { "literal": "n" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Duration", "symbols": ["Duration$string$3"] },
            { "name": "Duration$string$4", "symbols": [{ "literal": "u" }, { "literal": "n" }, { "literal": "t" }, { "literal": "i" }, { "literal": "l" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }, { "literal": "e" }, { "literal": "n" }, { "literal": "d" }, { "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "o" }, { "literal": "p" }, { "literal": "p" }, { "literal": "o" }, { "literal": "n" }, { "literal": "e" }, { "literal": "n" }, { "literal": "t" }, { "literal": "'" }, { "literal": "s" }, { "literal": " " }, { "literal": "t" }, { "literal": "u" }, { "literal": "r" }, { "literal": "n" }], "postprocess": function joiner(d) { return d.join(''); } },
            ...
            { "name": "Cant$string$3", "symbols": [{ "literal": "c" }, { "literal": "a" }, { "literal": "n" }, { "literal": "'" }, { "literal": "t" }, { "literal": " " }, { "literal": "a" }, { "literal": "t" }, { "literal": "t" }, { "literal": "a" }, { "literal": "c" }, { "literal": "k" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Cant", "symbols": ["Cant$string$3"] },
            ...
            { "name": "Evolve", "symbols": ["MultiTarget", "Evolve$string$1", "MultiTarget", "Evolve$ebnf$1", "Evolve$ebnf$2"], "postprocess": function (d, l) { return { raw_text: gv(d), action: 'evolve', target: d[0], target2: d[2], no_cost: !!d[4] }; } },
            ...
            { "name": "Play", "symbols": ["Play$subexpression$1", "MultiTarget", "Play$ebnf$1"], "postprocess": function (d, l) { return { raw_text: gv(d), action: 'play', target: d[1], no_cost: !!d[2] }; } },
            ...
            { "name": "Imperative", "symbols": ["Add"] },
            { "name": "Imperative", "symbols": ["Place"] },
            ...
            { "name": "Evolve$string$2", "symbols": [{ "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "v" }, { "literal": "i" }, { "literal": "n" }, { "literal": "g" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Evolve$string$3", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Evolve$ebnf$3", "symbols": ["ForFree"], "postprocess": id },
            { "name": "Evolve$ebnf$3", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Evolve", "symbols": ["Evolve$string$2", "MultiTarget", "Evolve$string$3", "MultiTarget", "Evolve$ebnf$3"] },
            ...
            { "name": "Trash$string$2", "symbols": [{ "literal": "t" }, { "literal": "r" }, { "literal": "a" }, { "literal": "s" }, { "literal": "h" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Trash", "symbols": ["Trash$string$2", "Target"], "postprocess": function (d, l) {
                    return {
            ...
            { "name": "StackClause$string$6", "symbols": [{ "literal": "a" }, { "literal": "s" }, { "literal": " " }, { "literal": "m" }, { "literal": "a" }, { "literal": "n" }, { "literal": "y" }, { "literal": " " }, { "literal": "o" }, { "literal": "r" }, { "literal": " " }, { "literal": "f" }, { "literal": "e" }, { "literal": "w" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }, { "literal": " " }, { "literal": "a" }, { "literal": "s" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "i" }, { "literal": "s" }, { "literal": " " }, { "literal": "M" }, { "literal": "o" }, { "literal": "n" }, { "literal": "s" }, { "literal": "t" }, { "literal": "e" }, { "literal": "r" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "StackClause", "symbols": ["StackClause$string$6"], "postprocess": function (d) {
                    return {
            ...
            { "name": "CardClause$string$3", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }, { "literal": "i" }, { "literal": "t" }, { "literal": "s" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CardClause", "symbols": [{ "literal": "[" }, "Trait", { "literal": "]" }, "CardClause$string$3"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'CardClause', trait: data[0], in: data[1], its: data[2], evolution: data[3], text: location.source }; } },
            { "name": "CardClause$string$4", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }, { "literal": "i" }, { "literal": "t" }, { "literal": "s" }, { "literal": " " }, { "literal": "t" }, { "literal": "e" }, { "literal": "x" }, { "literal": "t" }, { "literal": " " }, { "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "u" }, { "literal": "n" }, { "literal": "d" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "t" }, { "literal": "a" }, { "literal": "m" }, { "literal": "e" }, { "literal": "r" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CardClause", "symbols": [{ "literal": "[" }, "Trait", { "literal": "]" }, "CardClause$string$4"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'CardClause', trait: data[0], in: data[1], its: data[2], text: data[3], from: data[4], under: data[5], your: data[6], text: location.source }; } },
            { "name": "CardClause$string$5", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CardClause$string$6", "symbols": [{ "literal": " " }, { "literal": "o" }, { "literal": "r" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CardClause", "symbols": ["Object", "CardClause$string$5", "Possession", "CardClause$string$6", "Object"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'CardClause', object: data[0], in: data[1], possession: data[2], or: data[3], object: data[4], text: location.source }; } },
            { "name": "CardClause$string$7", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CardClause", "symbols": ["Object", "CardClause$string$7", "Possession"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'CardClause', object: data[0], in: data[1], possession: data[2], text: location.source }; } },
            ...
            { "name": "CostClause$string$2", "symbols": [{ "literal": " " }, { "literal": "e" }, { "literal": "q" }, { "literal": "u" }, { "literal": "a" }, { "literal": "l" }, { "literal": " " }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }, { "literal": "o" }, { "literal": "r" }, { "literal": " " }, { "literal": "l" }, { "literal": "o" }, { "literal": "w" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "a" }, { "literal": "n" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }, { "literal": "n" }, { "literal": "u" }, { "literal": "m" }, { "literal": "b" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }, { "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "CostClause", "symbols": ["CostNoun", "CostClause$string$2", "Location"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'CostClause', play: data[0], cost: data[1], equal: data[2], to: data[3], or: data[4], lower: data[5], than: data[6], the: data[7], number: data[8], of: data[9], evolution: data[10], cards: data[11], of: data[12], location: data[13], text: location.source }; } },
            ...
            { "name": "DPClause", "symbols": ["DPClause$string$2", "Object"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'DPClause', less: data[0], than: data[1], or: data[2], equal: data[3], to: data[4], object: data[5], text: location.source }; } },
            ...
            { "name": "OptionalLocation$string$1", "symbols": [{ "literal": " " }, { "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "OptionalLocation", "symbols": ["OptionalLocation$string$1", "Location"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'OptionalLocation', from: data[0], location: data[1], text: location.source }; } },
            ...
            { "name": "Location$string$1", "symbols": [{ "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "i" }, { "literal": "s" }, { "literal": " " }, { "literal": "m" }, { "literal": "o" }, { "literal": "n" }, { "literal": "s" }, { "literal": "t" }, { "literal": "e" }, { "literal": "r" }, { "literal": "'" }, { "literal": "s" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location", "symbols": ["Location$string$1"] },
            { "name": "Location$string$2", "symbols": [{ "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "1" }, { "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "b" }, { "literal": "l" }, { "literal": "u" }, { "literal": "e" }, { "literal": " " }, { "literal": "m" }, { "literal": "o" }, { "literal": "n" }, { "literal": "s" }, { "literal": "t" }, { "literal": "e" }, { "literal": "r" }, { "literal": "'" }, { "literal": "s" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location", "symbols": ["Location$string$2"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'Location', this: data[0], evolution: data[1], of: data[2], your: data[3], blue: data[4], evolution: data[5], text: location.source }; } },
            { "name": "Location$string$3", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }, { "literal": "i" }, { "literal": "t" }, { "literal": "s" }, { "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "u" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location", "symbols": ["Location$string$3"] },
            { "name": "Location$string$4", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location$string$5", "symbols": [{ "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location", "symbols": ["Location$string$4", "Possession", "Location$string$5"] },
            { "name": "Location$string$6", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }, { "literal": "i" }, { "literal": "t" }, { "literal": "s" }, { "literal": " " }, { "literal": "n" }, { "literal": "a" }, { "literal": "m" }, { "literal": "e" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Location", "symbols": ["Location$string$6"], "postprocess": function (data, location) { return { raw_text: gv(data), type: 'Location', in: data[0], its: data[1], evolution: data[2], possession: data[3], in: data[4], its: data[5], text: location.source }; } },
            ...
            { "name": "At$string$4", "symbols": [{ "literal": "B" }, { "literal": "L" }, { "literal": "A" }, { "literal": "H" }, { "literal": " " }, { "literal": "B" }, { "literal": "L" }, { "literal": "A" }, { "literal": "H" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "At$string$5", "symbols": [{ "literal": " " }, { "literal": "h" }, { "literal": "a" }, { "literal": "p" }, { "literal": "p" }, { "literal": "e" }, { "literal": "n" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "At", "symbols": ["At$string$3", "At$string$4", "At$string$5"], "postprocess": function (d, l) { return { raw_text: gv(d), type: 'At', text: l.source, phase: d[8], opponent: d[7] }; } },
            ...
            { "name": "MultiTarget", "symbols": ["Target", "MultiTarget$ebnf$1", "MultiTarget$ebnf$2"], "postprocess": function (d, l) {
                    ...
                    array.forEach(a => { a.from = d[2]; });
                    return { raw_text: gv(d), type: 'MultiTarget', case: "1ORMORE", targets: array, from: d[2] };
                } },
            ...
            { "name": "MultiTarget", "symbols": ["Adjectives", "MultiTarget$ebnf$7", { "literal": " " }, "Entity", "MultiTarget$ebnf$8"], "postprocess": function (d, l) {
                    ...
                    return { bob: d[3], raw_text: gv(d), type: 'MultiTarget', targets: [left, right], from: d[4] };
                } },
            ...
            { "name": "Target$ebnf$3$subexpression$1$string$1", "symbols": [{ "literal": " " }, { "literal": "u" }, { "literal": "n" }, { "literal": "d" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Target$ebnf$3$subexpression$1", "symbols": ["Target$ebnf$3$subexpression$1$string$1", "Target"] },
            ...
            { "name": "Article", "symbols": ["Article$ebnf$1"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            ...
            { "name": "Article", "symbols": ["Article$string$1", "Article$ebnf$2"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            ...
            { "name": "Article", "symbols": ["Article$string$5"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$6", "symbols": [{ "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "o" }, { "literal": "p" }, { "literal": "p" }, { "literal": "o" }, { "literal": "n" }, { "literal": "e" }, { "literal": "n" }, { "literal": "t" }, { "literal": "'" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$6"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "other" }; } },
            { "name": "Article$string$7", "symbols": [{ "literal": "a" }, { "literal": "n" }, { "literal": " " }, { "literal": "o" }, { "literal": "p" }, { "literal": "p" }, { "literal": "o" }, { "literal": "n" }, { "literal": "e" }, { "literal": "n" }, { "literal": "t" }, { "literal": "'" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$7"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "other" }; } },
            { "name": "Article$string$8", "symbols": [{ "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$8"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "self" }; } },
            { "name": "Article$string$9", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": "i" }, { "literal": "r" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$9"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$10", "symbols": [{ "literal": "a" }, { "literal": "n" }, { "literal": "y" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$10"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$11", "symbols": [{ "literal": "o" }, { "literal": "n" }, { "literal": "e" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$11"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$12", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "a" }, { "literal": "t" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$12"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$13", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "i" }, { "literal": "s" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$13"], "postprocess": function (d, l) { return { raw_text: gv(d), self: true }; } },
            { "name": "Adjective", "symbols": ["Article"], "postprocess": id },
            { "name": "Adjective$string$1", "symbols": [{ "literal": "o" }, { "literal": "f" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Adjective", "symbols": ["Adjective$string$1"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            ...
            { "name": "Adjective", "symbols": ["Adjective$string$3"], "postprocess": function (d, l) { return { raw_text: gv(d), colors: ['Green'] }; } },
            ...
            { "name": "Adjective", "symbols": ["Adjective$string$5"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            ...
            { "name": "FromRegion$string$2", "symbols": [{ "literal": " " }, { "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "t" }, { "literal": "r" }, { "literal": "a" }, { "literal": "s" }, { "literal": "h" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "FromRegion", "symbols": ["FromRegion$string$2"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "self", location: "trash" }; } },
            ...
            { "name": "FromRegion", "symbols": ["FromRegion$string$4"], "postprocess": function (d, l) {
                    return {
                        raw_text: gv(d), under: { raw_text: "this Monster", self: true }, location: "field",
                    };
                } },
            { "name": "FromRegion$string$5", "symbols": [{ "literal": " " }, { "literal": "f" }, { "literal": "r" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "h" }, { "literal": "a" }, { "literal": "n" }, { "literal": "d" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "FromRegion", "symbols": ["FromRegion$string$5"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "self", location: "hand" }; } },
            { "name": "FromRegion$string$6", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": " " }, { "literal": "y" }, { "literal": "o" }, { "literal": "u" }, { "literal": "r" }, { "literal": " " }, { "literal": "h" }, { "literal": "a" }, { "literal": "n" }, { "literal": "d" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "FromRegion", "symbols": ["FromRegion$string$6"], "postprocess": function (d, l) { return { raw_text: gv(d), player: "self", location: "hand" }; } },
            ...
            { "name": "Card", "symbols": ["Card$string$2"], "postprocess": function (d, l) {
                    return { raw_text: gv(d), entity: gv(d), and: [
                            { raw_text: "card", entity: "card" },
            ...
            { "name": "Card", "symbols": ["Card$string$3"] },
            { "name": "Card$string$4", "symbols": [{ "literal": "O" }, { "literal": "p" }, { "literal": "t" }, { "literal": "i" }, { "literal": "o" }, { "literal": "n" }, { "literal": " " }, { "literal": "c" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Card", "symbols": ["Card$string$4"] },
            { "name": "Card$string$5", "symbols": [{ "literal": "M" }, { "literal": "o" }, { "literal": "n" }, { "literal": "s" }, { "literal": "t" }, { "literal": "e" }, { "literal": "r" }, { "literal": " " }, { "literal": "C" }, { "literal": "a" }, { "literal": "r" }, { "literal": "d" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Card", "symbols": ["Card$string$5"] },
            ...
            { "name": "Card", "symbols": ["Card$string$6"] },
            ...
            { "name": "Monster$string$1", "symbols": [{ "literal": "M" }, { "literal": "o" }, { "literal": "n" }, { "literal": "s" }, { "literal": "t" }, { "literal": "e" }, { "literal": "r" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Monster$ebnf$1", "symbols": [{ "literal": "s" }], "postprocess": id },
            { "name": "Monster$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Monster", "symbols": ["Monster$string$1", "Monster$ebnf$1"], "postprocess": function (d, l) {
                    return { raw_text: gv(d), entity: gv(d), and: [
