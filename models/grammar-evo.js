...
function gv(x) { 
    ...
    if (x.raw_text) return x.raw_text;  
    if (typeof x === "string") return x; 
    if (Array.isArray(x)) { return x.map(element => gv(element)).join("") || "" }
    return `??${typeof x}??`; 
}
function gv2(x) { 
    return `??${typeof x}??`; 
...
var grammar = {
    ...
    {"name": "Top", "symbols": ["SolidEffect"]},
    {"name": "Top", "symbols": ["ForEach"]},
    ...
    {"name": "SolidEffect", "symbols": ["EffSentence", "SolidEffect$ebnf$1"], "postprocess":  function(d) { 
            //let sentences =  [d[0], ...d[1].map(x=>x[1]) ];
            // d[1] is the array
           ...
           const array = [d[0], ...d[1].map(x=>x[1]) ];
            ...
            for (let sentence of array) {
                ...
                if (sentence.effect) {
                    // not needed in most cases, but some sentences have multiple atomics
                    for (let i in sentence.effect) {
                        let temp_sentence = {...sentence };
                        let fx = sentence.effect[i];
                        temp_sentence.effect = fx;
    ...
    {"name": "WhenRemoval", "symbols": ["Target", "WhenRemoval$ebnf$1", {"literal":" "}, "Removal", "WhenRemoval$ebnf$2"], "postprocess":  function(d) { 
        return { raw_text: gv(d), target: d[0], event: d[3].event, 
        // is "cause" used?
        cause: d[4] && d[4][1],
        effect: d[4] && d[4][1] && d[4][1].cause === 'EFFECT'
        
         }; } },
    {"name": "Removal$subexpression$1$string$1", "symbols": [{"literal":"b"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Removal$subexpression$1", "symbols": ["Removal$subexpression$1$string$1"]},
    {"name": "Removal$subexpression$1$string$2", "symbols": [{"literal":"i"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Removal$subexpression$1", "symbols": ["Removal$subexpression$1$string$2"]},
    {"name": "Removal$string$1", "symbols": [{"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"l"}, {"literal":"e"}, {"literal":"t"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Removal", "symbols": ["Removal$subexpression$1", "Removal$string$1"], "postprocess": function(d) { return { raw_text: gv(d), event: ["DELETE"]} }},
    {"name": "Removal$string$2", "symbols": [{"literal":"l"}, {"literal":"e"}, {"literal":"a"}, {"literal":"v"}, {"literal":"e"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"b"}, {"literal":"a"}, {"literal":"t"}, {"literal":"t"}, {"literal":"l"}, {"literal":"e"}, {"literal":" "}, {"literal":"a"}, {"literal":"r"}, {"literal":"e"}, {"literal":"a"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Removal", "symbols": ["Removal$string$2"], "postprocess": function(d) { return { raw_text: gv(d), event: ["ALL_REMOVAL"] } }},
    {"name": "Removal$string$3", "symbols": [{"literal":"b"}, {"literal":"e"}, {"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"l"}, {"literal":"e"}, {"literal":"t"}, {"literal":"e"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"r"}, {"literal":"e"}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":"e"}, {"literal":"d"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"h"}, {"literal":"a"}, {"literal":"n"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Removal", "symbols": ["Removal$string$3"], "postprocess":  function(d) { return { raw_text: gv(d), 
    ...
    {"name": "Reason$string$2", "symbols": [{"literal":"b"}, {"literal":"y"}, {"literal":" "}, {"literal":"a"}, {"literal":"n"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Reason", "symbols": ["Reason$string$2"], "postprocess":  function(d) {
        return { raw_text: gv(d), cause: "EFFECT"} } },
    ...
    {"name": "EffSentence$ebnf$6$subexpression$1$string$1", "symbols": [{"literal":"A"}, {"literal":"m"}, {"literal":"o"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"m"}, {"literal":","}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EffSentence$ebnf$6$subexpression$1", "symbols": ["EffSentence$ebnf$6$subexpression$1$string$1"]},
    {"name": "EffSentence$ebnf$6$subexpression$1$string$2", "symbols": [{"literal":"f"}, {"literal":"r"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"i"}, {"literal":"s"}, {"literal":" "}, {"literal":"M"}, {"literal":"o"}, {"literal":"n"}, {"literal":"s"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}, {"literal":"s"}, {"literal":","}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EffSentence$ebnf$6$subexpression$1", "symbols": ["EffSentence$ebnf$6$subexpression$1$string$2"]},
    ...
    {"name": "EffSentence$ebnf$7", "symbols": ["ForEach"], "postprocess": id},
    ...
    {"name": "EffSentence$ebnf$8$subexpression$1", "symbols": [{"literal":" "}, "Duration"]},
    ...
    {"name": "EffSentence$ebnf$9$subexpression$1", "symbols": [{"literal":" "}, "ForEach"]},
    ...
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$1", "symbols": [{"literal":","}], "postprocess": id},
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$10$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$2", "symbols": [{"literal":","}], "postprocess": id},
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$3", "symbols": ["Duration"], "postprocess": id},
    {"name": "EffSentence$ebnf$10$subexpression$1$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$10$subexpression$1", "symbols": ["EffSentence$ebnf$10$subexpression$1$ebnf$1", "EffSentence$ebnf$10$subexpression$1$string$1", "EffSentence$ebnf$10$subexpression$1$ebnf$2", {"literal":" "}, "EffSentence$ebnf$10$subexpression$1$ebnf$3", "Declarative"]},
    {"name": "EffSentence$ebnf$10", "symbols": ["EffSentence$ebnf$10$subexpression$1"], "postprocess": id},
    {"name": "EffSentence$ebnf$10", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$11", "symbols": [{"literal":"."}], "postprocess": id},
    {"name": "EffSentence$ebnf$11", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$12", "symbols": ["ExtraSentence"], "postprocess": id},
    {"name": "EffSentence$ebnf$12", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence$ebnf$13", "symbols": ["ForEachSentence"], "postprocess": id},
    {"name": "EffSentence$ebnf$13", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence", "symbols": ["EffSentence$ebnf$1", "EffSentence$ebnf$2", "EffSentence$ebnf$3", "EffSentence$ebnf$4", "EffSentence$ebnf$5", "EffSentence$ebnf$6", "EffSentence$ebnf$7", "EffSentence$subexpression$1", "EffSentence$ebnf$8", "EffSentence$ebnf$9", "EffSentence$ebnf$10", "EffSentence$ebnf$11", "EffSentence$ebnf$12", "EffSentence$ebnf$13"], "postprocess": function(d,l,r) { 
          let extra = d[12];
          let for_each = d[13];
          let from_value = d[5] && d[5][0] && { raw_text: gv(d[5][0]), location: d[5][0].includes("them") ? "search" : "hand" };
          let from_string = from_value && from_value.raw_text.match(/['A-Z ]*/i)?.[0]
        ...
        //  console.error(214, effects);
         // console.error(215, next_effect);
          ...
          for (let effect of effects) {
              if (d[6] || d[9]) {
                  let target_count = d[6];
                  let run_count = d[9] && d[9][1];
                  let fe = target_count || run_count;
                  let has_keyword = effect.raw_text.includes("＜");
                  // d[6] mathces are allowed since they won't match other things
                  if (true || target_count || has_keyword) {
                      effect.action_args.for_each = fe.for_each;
                      effect.action_args.note = "for each assigned from above";
                  } else {
                      // matching here was bad in some cases, that have now been fixed
                      return r;
                  }
              }
              ...
              if (effect.action_args && effect.action_args.duration) { 
                  ...
                  // set from for each one
              if (from_value) {
                  effect.action_args.target.targets[0].from = from_value;
                  effect.action_args.target.targets[0].note = 'from set from above, but not used yet';
                  if (! effect.action_args.target.note) {
                      effect.action_args.target.raw_text += " " + from_string;
                      effect.action_args.target.note = 'raw_text modified';
                  }
              }
    ...
    {"name": "EffSentence$ebnf$14", "symbols": [{"literal":","}], "postprocess": id},
    {"name": "EffSentence$ebnf$14", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "EffSentence", "symbols": ["Cost", "EffSentence$ebnf$14"], "postprocess":  function(d) { return { 
    ...
    {"name": "EffSentence", "symbols": ["Duration", "EffSentence$string$1", "WhenSentence", "EffSentence$string$2", "Cost", "EffSentence$string$3", "Imperative", {"literal":"."}], "postprocess":  function(d) { return { 
        raw_text:gv(d), type: 'EffSentence', kind: "pending", when: d[2], 
        rendered: "The next time " + gv(d[2]) + ", " + gv(d[4]) + ", " + gv(d[6]) + "." } } },
    {"name": "EffSentence", "symbols": ["Activate"]},
    {"name": "EffSentence$string$4", "symbols": [{"literal":"R"}, {"literal":"e"}, {"literal":"v"}, {"literal":"e"}, {"literal":"a"}, {"literal":"l"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":"p"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EffSentence$string$5", "symbols": [{"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}, {"literal":"s"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":"."}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EffSentence", "symbols": ["EffSentence$string$4", "Number", "EffSentence$string$5"]},
    {"name": "EffSentence$string$6", "symbols": [{"literal":"R"}, {"literal":"e"}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"r"}, {"literal":"e"}, {"literal":"s"}, {"literal":"t"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":"."}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "ExtraSentence", "symbols": ["ExtraSentence$string$2"], "postprocess":  function(d) { return { 
    ...
    {"name": "EachModify$string$6", "symbols": [{"literal":"a"}, {"literal":"d"}, {"literal":"d"}, {"literal":" "}, {"literal":"1"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"i"}, {"literal":"s"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"y"}, {"literal":" "}, {"literal":"c"}, {"literal":"o"}, {"literal":"s"}, {"literal":"t"}, {"literal":" "}, {"literal":"m"}, {"literal":"a"}, {"literal":"x"}, {"literal":"i"}, {"literal":"m"}, {"literal":"u"}, {"literal":"m"}, {"literal":"."}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "EachModify", "symbols": ["EachModify$string$6"]},
    ...
    {"name": "SpecialCaseDelay", "symbols": ["SpecialCaseDelay$string$1", "NestedEffect", {"literal":"."}], "postprocess": 
        function(d,l) { 
            return [{ raw_text:gv(d), type: 'Action', action: 'Delay', nested_solid: d[1].nested_solid, 
                      nested_solid_s: d[1].nested_s }];
                       } },
    {"name": "Activate", "symbols": ["ActivateCount", {"literal":"."}, "NestedEffect"]},
    {"name": "ActivateCount$string$1", "symbols": [{"literal":"A"}, {"literal":"c"}, {"literal":"t"}, {"literal":"i"}, {"literal":"v"}, {"literal":"a"}, {"literal":"t"}, {"literal":"e"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$1$string$1", "symbols": [{"literal":"f"}, {"literal":"o"}, {"literal":"l"}, {"literal":"l"}, {"literal":"o"}, {"literal":"w"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$1", "symbols": ["ActivateCount$ebnf$1$string$1"], "postprocess": id},
    {"name": "ActivateCount$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ActivateCount$string$2", "symbols": [{"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$2$string$1", "symbols": [{"literal":" "}, {"literal":"b"}, {"literal":"e"}, {"literal":"l"}, {"literal":"o"}, {"literal":"w"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$2", "symbols": ["ActivateCount$ebnf$2$string$1"], "postprocess": id},
    {"name": "ActivateCount$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ActivateCount$ebnf$3$string$1", "symbols": [{"literal":" "}, {"literal":"t"}, {"literal":"w"}, {"literal":"i"}, {"literal":"c"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$3", "symbols": ["ActivateCount$ebnf$3$string$1"], "postprocess": id},
    {"name": "ActivateCount$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ActivateCount$ebnf$4$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"t"}, {"literal":"i"}, {"literal":"m"}, {"literal":"e"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ActivateCount$ebnf$4$subexpression$1", "symbols": [{"literal":" "}, "Number", "ActivateCount$ebnf$4$subexpression$1$string$1"]},
    ...
    {"name": "NestedEffect", "symbols": [{"literal":"・"}, "EffSentence", "NestedEffect$ebnf$1"], "postprocess": 
        function(d,l) { 
    ...
    {"name": "Declarative", "symbols": ["Declarative$ebnf$1", "Declarative$subexpression$1", "Declarative$ebnf$2"], "postprocess":  function(d) { 
          ...
          from: null
            ...
            return actions.map(function(x, index) { return {
             raw_text:gv(d), 
             line: 244, 
             type:effect.type, 
             action:x, 
    ...
    {"name": "YouDeclare$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"Y"}, {"literal":"o"}, {"literal":"u"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "YouDeclare$ebnf$1$subexpression$1", "symbols": ["YouDeclare$ebnf$1$subexpression$1$string$1"]},
    {"name": "YouDeclare$ebnf$1$subexpression$1$string$2", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "YouDeclare$ebnf$1$subexpression$1", "symbols": ["YouDeclare$ebnf$1$subexpression$1$string$2"]},
    {"name": "YouDeclare$ebnf$1", "symbols": ["YouDeclare$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "YouDeclare$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "YouDeclare$ebnf$2$string$1", "symbols": [{"literal":" "}, {"literal":"m"}, {"literal":"a"}, {"literal":"y"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "YouDeclare$ebnf$2", "symbols": ["YouDeclare$ebnf$2$string$1"], "postprocess": id},
    {"name": "YouDeclare$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "YouDeclare", "symbols": ["YouDeclare$ebnf$1", "YouDeclare$ebnf$2", "Action"], "postprocess":  function(d,l) { return [ { 
         raw_text:gv(d),
        // xxx_d2: d[2],
         optional:!!d[1],
         line: 246,
    ...
    {"name": "DeclareCentral", "symbols": ["MultiTarget", {"literal":" "}, "DeclareCentral$ebnf$1", "Actions"], "postprocess":  function(d,l) {
        ...
        return { 
         ...
         nested_effect: acx.nested_effect,
    ...
    {"name": "DeclareCentral", "symbols": ["MultiTarget", {"literal":" "}, "DeclareCentral$ebnf$2", "Verb1"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
        optional: !!d[2],
        type: 'Action',
        action: d[3].action,
    ...
    {"name": "DeclareCentral", "symbols": ["DeclareCentral$ebnf$3", "Immunes", {"literal":" "}, "MultiTarget"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
        line: 266,
        target: d[3],
        type: 'Action',
    ...
    {"name": "DeclareCentral", "symbols": ["MultiTarget", {"literal":" "}, "Immunes"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
        line: 381,
        target: d[0],
        type: 'Action',
    ...
    {"name": "DeclareCentral$string$5", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"a"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "DeclareCentral$ebnf$6$string$1", "symbols": [{"literal":" "}, {"literal":"w"}, {"literal":"i"}, {"literal":"t"}, {"literal":"h"}, {"literal":" "}, {"literal":"＜"}, {"literal":"D"}, {"literal":"e"}, {"literal":"-"}, {"literal":"E"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":"＞"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "DeclareCentral", "symbols": ["DeclareCentral$string$2", "MultiTarget", "DeclareCentral$string$3", "DeclareCentral$ebnf$4", "DeclareCentral$string$4", "DeclareCentral$ebnf$5", "DeclareCentral$string$5", "MultiTarget", "DeclareCentral$ebnf$6", "DeclareCentral$ebnf$7"], "postprocess":  function(d,l) { 
        console.error("overbroad immunity"); // and same multitarget for both
        return { 
        raw_text:gv(d),
        line: 384,
        target: d[1],
    ...
    {"name": "Actions$ebnf$1$subexpression$1$ebnf$1", "symbols": [{"literal":","}], "postprocess": id},
    ...
    {"name": "Actions", "symbols": ["DeclareAction", "Actions$ebnf$1"], "postprocess":  function(d,l) { 
        ...
        return { 
         ...
         array: array, // 
         type: 'Action',
         action: array.find(a => a.action)?.action,
         actions: array.filter(a=>a.action).map(a => a.action),
         dp_change: array.find(a => a.dp_change)?.dp_change,
         without_suspending: array.find(a => a.without_suspending)?.without_suspending,
         target2_text: array.find(a => a.target2_text)?.target2_text,
         keyword_gains: array.find(a => a.keyword_gains)?.keyword_gains,
         nested_effect: array.find(a => a.nested_effect)?.nested_effect,
         for_each: array.find(a => a.for_each)?.for_each,
         // we could have multiple statuses 
         status: array.map(a => a.status).filter(a => !!a),
         // if just 1 action has a duration we might encounter it inside here
         duration: array.find(a => a.duration)?.duration,
         }; } },
    ...
    {"name": "Duration", "symbols": ["Duration$string$1"], "postprocess":  function(d) { return { 
    ...
    {"name": "Duration", "symbols": ["Duration$ebnf$1", "Duration$ebnf$2", "Duration$string$2", "Duration$ebnf$3", "Duration$ebnf$4"], "postprocess":  function(d) { return { 
    ...
    {"name": "Duration$subexpression$1$string$4", "symbols": [{"literal":"U"}, {"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":","}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Duration$subexpression$1", "symbols": ["Duration$subexpression$1$string$4"]},
    {"name": "Duration$subexpression$1$string$5", "symbols": [{"literal":"u"}, {"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"i"}, {"literal":"r"}, {"literal":" "}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Duration$subexpression$1", "symbols": ["Duration$subexpression$1$string$5"]},
    {"name": "Duration$subexpression$1$string$6", "symbols": [{"literal":"u"}, {"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"i"}, {"literal":"r"}, {"literal":" "}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":" "}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Duration$subexpression$1", "symbols": ["Duration$subexpression$1$string$6"]},
    {"name": "Duration$subexpression$1$string$7", "symbols": [{"literal":"U"}, {"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":" "}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":"s"}, {"literal":","}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Duration$subexpression$1", "symbols": ["Duration$subexpression$1$string$7"]},
    ...
    {"name": "Duration", "symbols": ["Duration$subexpression$1", "Duration$ebnf$5"], "postprocess":  function(d) { return { 
        raw_text:gv(d), expiration: { END_OF_TURN: "OPPONENT" }    } } },
    {"name": "Duration$subexpression$2", "symbols": [{"literal":"U"}]},
    {"name": "Duration$subexpression$2", "symbols": [{"literal":"u"}]},
    {"name": "Duration$string$3", "symbols": [{"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Duration", "symbols": ["Duration$subexpression$2", "Duration$string$3"], "postprocess":  function(d) { return { 
        raw_text:gv(d), expiration: { END_OF_TURN: "YOUR" }    } } },
    ...
    {"name": "Cant$subexpression$1$string$1", "symbols": [{"literal":"Y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Cant$subexpression$1", "symbols": ["Cant$subexpression$1$string$1"]},
    {"name": "Cant$subexpression$1$string$2", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Cant$subexpression$1", "symbols": ["Cant$subexpression$1$string$2"]},
    {"name": "Cant$string$3", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"s"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"n"}, {"literal":"'"}, {"literal":"t"}, {"literal":" "}, {"literal":"r"}, {"literal":"e"}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Cant$string$4", "symbols": [{"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":" "}, {"literal":"h"}, {"literal":"a"}, {"literal":"n"}, {"literal":"d"}, {"literal":"s"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"d"}, {"literal":"e"}, {"literal":"c"}, {"literal":"k"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Cant", "symbols": ["Cant$subexpression$1", "Cant$string$3", "MultiTarget", "Cant$string$4"], "postprocess": function(d) { return {
           raw_text:gv(d),
           type: 'Cant',
           action: 'give status',
           target: d[2], 
           immune: true,
           status: [
               { event: 'FIELD_TO_HAND', immune: true, target: 'their' },
               { event: 'TO_BOTTOM_DECK', immune: true, target: 'their' },
           ]
           }; 
        } },
    {"name": "Cant$string$5", "symbols": [{"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"n"}, {"literal":"'"}, {"literal":"t"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Cant$string$6", "symbols": [{"literal":" "}, {"literal":"m"}, {"literal":"a"}, {"literal":"y"}, {"literal":" "}, {"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":" "}, {"literal":"a"}, {"literal":"t"}, {"literal":"t"}, {"literal":"a"}, {"literal":"c"}, {"literal":"k"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Cant", "symbols": ["MultiTarget", "Cant$string$6"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
        type: 'Action',
        action: 'attack',
        optional: true,
    ...
    {"name": "CantActions", "symbols": ["CantActions$string$1", "CantActions$ebnf$1"], "postprocess":  function (d) { return {
    ...
    {"name": "CantActions", "symbols": ["CantActions$string$2"], "postprocess":  function (d) { return {
    ...
    {"name": "Action$subexpression$1", "symbols": ["UnSuspend"]},
    {"name": "Action", "symbols": ["Action$subexpression$1"], "postprocess":  function(ds,l) {const d = ds[0]; return { 
        raw_text:gv(d),  
        type: 'Action', 
        line: 380, 
        action: d[0].action, 
    ...
    {"name": "ForFree$ebnf$4$string$1", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"y"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "ForFree$ebnf$5$string$1", "symbols": [{"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "ForFree$ebnf$6$string$1", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"s"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ForFree$ebnf$6", "symbols": ["ForFree$ebnf$6$string$1"], "postprocess": id},
    {"name": "ForFree$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ForFree$ebnf$7", "symbols": [{"literal":"s"}], "postprocess": id},
    {"name": "ForFree$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ForFree", "symbols": ["ForFree$string$1", "ForFree$ebnf$1", "ForFree$ebnf$2", "ForFree$ebnf$3", "ForFree$ebnf$4", "ForFree$ebnf$5", "ForFree$ebnf$6", "ForFree$ebnf$7"]},
    ...
    {"name": "ForDiscount", "symbols": ["ForDiscount$string$1", "ForDiscount$ebnf$1", "ForDiscount$string$2", "ForDiscount$ebnf$2", "ForDiscount$string$3", "Number"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
    ...
    {"name": "Attacks$ebnf$4$subexpression$1$subexpression$1$string$1", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Attacks$ebnf$4$subexpression$1$subexpression$1", "symbols": ["Attacks$ebnf$4$subexpression$1$subexpression$1$string$1"]},
    {"name": "Attacks$ebnf$4$subexpression$1$subexpression$1$string$2", "symbols": [{"literal":"a"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Attacks$ebnf$4$subexpression$1$subexpression$1", "symbols": ["Attacks$ebnf$4$subexpression$1$subexpression$1$string$2"]},
    {"name": "Attacks$ebnf$4$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"M"}, {"literal":"o"}, {"literal":"n"}, {"literal":"s"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Attacks$ebnf$4$subexpression$1", "symbols": ["Attacks$ebnf$4$subexpression$1$subexpression$1", "Attacks$ebnf$4$subexpression$1$string$1"]},
    {"name": "Attacks$ebnf$4", "symbols": ["Attacks$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "Attacks$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Attacks$ebnf$5", "symbols": [{"literal":" "}], "postprocess": id},
    {"name": "Attacks$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Attacks$ebnf$6", "symbols": ["WithoutSuspending"], "postprocess": id},
    {"name": "Attacks$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Attacks", "symbols": ["Attacks$string$1", "Attacks$ebnf$1", "Attacks$ebnf$2", "Attacks$ebnf$3", "Attacks$ebnf$4", "Attacks$ebnf$5", "Attacks$ebnf$6"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),
        type: 'Action',
        target2_text: d[3] || gv(d[4]),
        action: 'attack',
        without_suspending: !!d[6],
        }; } },
    ...
    {"name": "Evolve", "symbols": ["MultiTarget", "Evolve$string$2", "MultiTarget"], "postprocess":  function(d,l) { 
        return { optional: true, raw_text:gv(d),  action:'evolve', appfuse: true,  target2: d[0], target: d[2]  }; } },
    ...
    {"name": "Devolve$subexpression$1", "symbols": ["Devolve$subexpression$1$string$2"]},
    {"name": "Devolve$string$1", "symbols": [{"literal":","}, {"literal":" "}, {"literal":"＜"}, {"literal":"D"}, {"literal":"e"}, {"literal":"-"}, {"literal":"E"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Devolve", "symbols": ["Devolve$subexpression$1", "MultiTarget", "Devolve$string$1", "Number", {"literal":"＞"}], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),  action:'devolve', target: d[1], number: gv(d[3]) }; } },
    {"name": "Devolve$string$2", "symbols": [{"literal":"＜"}, {"literal":"D"}, {"literal":"e"}, {"literal":"-"}, {"literal":"E"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Devolve$string$3", "symbols": [{"literal":"＞"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Devolve", "symbols": ["Devolve$string$2", "Number", "Devolve$string$3", "MultiTarget"], "postprocess":  function(d,l) { return { 
    ...
    {"name": "Attack", "symbols": ["Attack$subexpression$1", "Attack$string$1", "MultiTarget", "Attack$ebnf$1"], "postprocess":  function(d,l) { return { 
    ...
    {"name": "Play", "symbols": ["Play$subexpression$1", "MultiTarget", "Play$ebnf$1"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d), line:636,  action:'play', target: d[1], no_cost: !!d[2]  }; } },
    ...
    {"name": "Link", "symbols": ["Link$subexpression$1", "MultiTarget", "Link$subexpression$2", "MultiTarget", "Link$ebnf$1"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d),  action:'link', target: d[1], target2: d[3], no_cost: !!d[4]  }; } },
    {"name": "UnSuspend$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"u"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "UnSuspend$ebnf$1$subexpression$1", "symbols": ["UnSuspend$ebnf$1$subexpression$1$string$1"]},
    {"name": "UnSuspend$ebnf$1$subexpression$1$string$2", "symbols": [{"literal":"U"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "UnSuspend$ebnf$1$subexpression$1", "symbols": ["UnSuspend$ebnf$1$subexpression$1$string$2"]},
    {"name": "UnSuspend$ebnf$1", "symbols": ["UnSuspend$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "UnSuspend$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "UnSuspend$subexpression$1$string$1", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"s"}, {"literal":"p"}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "UnSuspend$subexpression$1", "symbols": ["UnSuspend$subexpression$1$string$1"]},
    {"name": "UnSuspend$subexpression$1$string$2", "symbols": [{"literal":"S"}, {"literal":"u"}, {"literal":"s"}, {"literal":"p"}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "UnSuspend$subexpression$1", "symbols": ["UnSuspend$subexpression$1$string$2"]},
    {"name": "UnSuspend$ebnf$2$subexpression$1$string$1", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "UnSuspend$ebnf$2$subexpression$1", "symbols": ["UnSuspend$ebnf$2$subexpression$1$string$1"]},
    {"name": "UnSuspend$ebnf$2$subexpression$1", "symbols": [{"literal":"s"}]},
    {"name": "UnSuspend$ebnf$2", "symbols": ["UnSuspend$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "UnSuspend$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "UnSuspend", "symbols": ["UnSuspend$ebnf$1", "UnSuspend$subexpression$1", "UnSuspend$ebnf$2", {"literal":" "}, "MultiTarget"], "postprocess":  function(d,l) { return { 
        raw_text:gv(d), action: d[0] ? 'unsuspend' : 'suspend', target: d[4] }; } },
    ...
    {"name": "Return$ebnf$1$string$1", "symbols": [{"literal":" "}, {"literal":"i"}, {"literal":"n"}, {"literal":" "}, {"literal":"a"}, {"literal":"n"}, {"literal":"y"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":"d"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Return$ebnf$1", "symbols": ["Return$ebnf$1$string$1"], "postprocess": id},
    {"name": "Return$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Return", "symbols": ["Return$subexpression$1", "MultiTarget", "Return$string$1", "Return$subexpression$2", "Return$string$2", "Return$ebnf$1"], "postprocess":  function(d,l) { return {
    ...
    {"name": "Return", "symbols": ["Return$subexpression$3", "MultiTarget", "Return$string$3", "Return$subexpression$4", "Return$string$4"], "postprocess":  function(d,l) { return {
    ...
    {"name": "ModifyCost", "symbols": ["ModifyCost$string$1", "ModifyCost$ebnf$1", "ModifyCost$ebnf$2", "ModifyCost$ebnf$3", "ModifyCost$ebnf$4", "ModifyCost$string$2", "ModifyCost$ebnf$5", "ModifyCost$string$3", "Number"], "postprocess":  
        function(d,l) { return { raw_text:gv(d), action: 'modifycost', number: gv(d[8]) }; } },
    ...
    {"name": "ForEach$subexpression$3$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"2"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ForEach$subexpression$3$ebnf$1$subexpression$1", "symbols": ["ForEach$subexpression$3$ebnf$1$subexpression$1$string$1"]},
    {"name": "ForEach$subexpression$3$ebnf$1", "symbols": ["ForEach$subexpression$3$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "ForEach$subexpression$3$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "ForEach$subexpression$3$string$2", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"T"}, {"literal":"a"}, {"literal":"m"}, {"literal":"e"}, {"literal":"r"}, {"literal":"s"}, {"literal":"'"}, {"literal":" "}, {"literal":"c"}, {"literal":"o"}, {"literal":"l"}, {"literal":"o"}, {"literal":"r"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ForEach$subexpression$3", "symbols": ["ForEach$subexpression$3$ebnf$1", "ForEach$subexpression$3$string$2"]},
    ...
    {"name": "ForEach$subexpression$3$string$5", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"a"}, {"literal":"t"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"c"}, {"literal":"o"}, {"literal":"l"}, {"literal":"o"}, {"literal":"r"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ForEach$subexpression$3", "symbols": ["ForEach$subexpression$3$string$5"]},
    {"name": "ForEach$subexpression$3$string$6", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"l"}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"i"}, {"literal":"n"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ForEach$subexpression$3", "symbols": ["ForEach$subexpression$3$string$6", "MultiTarget"]},
    ...
    {"name": "ForEach", "symbols": ["ForEach$subexpression$1", "ForEach$subexpression$2", "ForEach$ebnf$1", "ForEach$subexpression$3", "ForEach$ebnf$2", "ForEach$ebnf$3"], "postprocess":  function(d) { return { 
        type: "ForEach-1",
    ...
    {"name": "ForEach", "symbols": ["ForEach$subexpression$4", "MultiTarget", "ForEach$ebnf$4", "ForEach$ebnf$5"], "postprocess":  function(d) { return { 
        type: "ForEach-2",
    ...
    {"name": "OneStatusThingy", "symbols": ["OneStatusThingy$ebnf$1", "Number", "OneStatusThingy$string$1"], "postprocess":  function(d) { return { 
            raw_text:gv(d),  action:'give status',
            key: 'dp_change',
            value: "gets " + gv([  d[0], d[1], d[2] ]),
        }; } },
    {"name": "OneStatusThingy", "symbols": ["Keyword"], "postprocess":  function(d) { return { 
        raw_text:gv(d),  action:'give status',
        key: 'keyword_gains',
        value: "gains " + gv(d[0]) }; }  },
    {"name": "OneStatusThingy", "symbols": [{"literal":"\""}, "FullEffLine", {"literal":"\""}], "postprocess":  function(d) { return { 
         raw_text:gv(d),  action:'give status',
         key: 'nested_effect',
         value:  gv(d[1]),
        // xxx_d1: d[1],
    ...
    {"name": "Gets$subexpression$1$string$2", "symbols": [{"literal":"g"}, {"literal":"e"}, {"literal":"t"}, {"literal":"s"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Gets", "symbols": ["Gets$ebnf$1", "Gets$subexpression$1", "StatusThingy"], "postprocess":  function(d) { return { 
            ...d[2],
            raw_text:gv(d),  action:'give status',
                for_each: d[0] && d[0].for_each,
        }} },
    ...
    {"name": "Gains", "symbols": ["Gains$subexpression$1", "StatusThingy"], "postprocess":  function(d) { return { 
            ...d[1],
    ...
    {"name": "Immunes$subexpression$1$subexpression$1$string$1", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"i"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Immunes$subexpression$1$subexpression$1", "symbols": ["Immunes$subexpression$1$subexpression$1$string$1"]},
    {"name": "Immunes$subexpression$1$subexpression$1$string$2", "symbols": [{"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Immunes$subexpression$1$subexpression$1", "symbols": ["Immunes$subexpression$1$subexpression$1$string$2"]},
    {"name": "Immunes$subexpression$1$string$2", "symbols": [{"literal":" "}, {"literal":"M"}, {"literal":"o"}, {"literal":"n"}, {"literal":"s"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"s"}, {"literal":" "}, {"literal":"d"}, {"literal":"o"}, {"literal":"n"}, {"literal":"'"}, {"literal":"t"}, {"literal":" "}, {"literal":"a"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Immunes$subexpression$1", "symbols": ["Immunes$subexpression$1$subexpression$1", "Immunes$subexpression$1$string$2"]},
    {"name": "Immunes", "symbols": ["Immunes$subexpression$1"], "postprocess":  function(d) { return { 
        raw_text:gv(d),
        type: 'Status',
        action: 'give status',
        status: { 
    ...
    {"name": "Immunes$string$1", "symbols": [{"literal":"c"}, {"literal":"a"}, {"literal":"n"}, {"literal":"'"}, {"literal":"t"}, {"literal":" "}, {"literal":"h"}, {"literal":"a"}, {"literal":"v"}, {"literal":"e"}, {"literal":" "}, {"literal":"i"}, {"literal":"t"}, {"literal":"s"}, {"literal":" "}, {"literal":"D"}, {"literal":"P"}, {"literal":" "}, {"literal":"r"}, {"literal":"e"}, {"literal":"d"}, {"literal":"u"}, {"literal":"c"}, {"literal":"e"}, {"literal":"d"}, {"literal":" "}, {"literal":"b"}, {"literal":"y"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"o"}, {"literal":"p"}, {"literal":"p"}, {"literal":"o"}, {"literal":"n"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Immunes", "symbols": ["Immunes$string$1"], "postprocess":  function(d) { return { 
        raw_text:gv(d),
        type: 'Status',
        action: 'give status',
        status: { 
    ...
    {"name": "Immunes$string$2", "symbols": [{"literal":"i"}, {"literal":"s"}, {"literal":"n"}, {"literal":"'"}, {"literal":"t"}, {"literal":" "}, {"literal":"a"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"e"}, {"literal":"d"}, {"literal":" "}, {"literal":"b"}, {"literal":"y"}, {"literal":" "}, {"literal":"＜"}, {"literal":"D"}, {"literal":"e"}, {"literal":"-"}, {"literal":"E"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":"＞"}, {"literal":" "}, {"literal":"e"}, {"literal":"f"}, {"literal":"f"}, {"literal":"e"}, {"literal":"c"}, {"literal":"t"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Immunes", "symbols": ["Immunes$string$2"], "postprocess":  function(d) { return { 
        raw_text:gv(d),
        type: 'Status',
        action: 'give status',
        status: { 
    ...
    {"name": "_Imperative$subexpression$1", "symbols": ["UnSuspend"]},
    ...
    {"name": "_Imperative", "symbols": ["_Imperative$subexpression$1"], "postprocess":  function(ds,l) { 
            const d = ds[0]; return { raw_text:gv(d),  
        type: 'Action', 
        action: d[0].action, 
        line: 472, 
        action_args:d[0] }; } },
    ...
    {"name": "Draw", "symbols": ["Draw$string$1", "Number", {"literal":"＞"}], "postprocess":  function(d,l) { return { 
    ...
    {"name": "Add$subexpression$1$string$3", "symbols": [{"literal":"a"}, {"literal":"d"}, {"literal":"d"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Add$subexpression$1", "symbols": ["Add$subexpression$1$string$3"]},
    ...
    {"name": "Add$ebnf$2$string$1", "symbols": [{"literal":" "}, {"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":"_"}, {"literal":"a"}, {"literal":"m"}, {"literal":"o"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Add$ebnf$2", "symbols": ["Add$ebnf$2$string$1"], "postprocess": id},
    {"name": "Add$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Add$string$1", "symbols": [{"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Add", "symbols": ["Add$subexpression$1", "MultiTarget", "Add$ebnf$1", "Add$ebnf$2", "Add$string$1", "Add$subexpression$2", "Add$string$2"], "postprocess":  
        function(d, l, r) { 
            let target = d[1];
            target.line = 648;
            // To stop this from matching "add security to hand" since our verb is REVEAL-to-hand
            if (target.raw_text.includes("security") || 
                target.raw_text.includes("this card")) { return r; }
        //    target.upto = true; // eternal debate about 1A and 1 B
            return { 
            upto: true,
            raw_text:gv(d),  action: 'RevealToHand', 
            target: target,
    ...
    {"name": "Add", "symbols": ["Add$string$3", "Add$subexpression$3", "Add$string$4"], "postprocess":  function(d) { return { 
    ...
    {"name": "Place$subexpression$2$string$1", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$2", "symbols": ["Place$subexpression$2$string$1"]},
    {"name": "Place$subexpression$2$string$2", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$2", "symbols": ["Place$subexpression$2$string$2"]},
    {"name": "Place$subexpression$3$string$1", "symbols": [{"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$3", "symbols": ["Place$subexpression$3$string$1"]},
    {"name": "Place$subexpression$3$string$2", "symbols": [{"literal":"t"}, {"literal":"o"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$3", "symbols": ["Place$subexpression$3$string$2"]},
    {"name": "Place$subexpression$4$string$1", "symbols": [{"literal":" "}, {"literal":"s"}, {"literal":"e"}, {"literal":"c"}, {"literal":"u"}, {"literal":"r"}, {"literal":"i"}, {"literal":"t"}, {"literal":"y"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$4", "symbols": ["Place$subexpression$4$string$1"]},
    {"name": "Place$subexpression$4$string$2", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"y"}, {"literal":"o"}, {"literal":"u"}, {"literal":"r"}, {"literal":" "}, {"literal":"s"}, {"literal":"e"}, {"literal":"c"}, {"literal":"u"}, {"literal":"r"}, {"literal":"i"}, {"literal":"t"}, {"literal":"y"}, {"literal":" "}, {"literal":"s"}, {"literal":"t"}, {"literal":"a"}, {"literal":"c"}, {"literal":"k"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$4", "symbols": ["Place$subexpression$4$string$2"]},
    {"name": "Place", "symbols": ["Place$subexpression$1", "MultiTarget", "Place$ebnf$1", "Place$subexpression$2", "Place$subexpression$3", "Place$subexpression$4"], "postprocess":  function(d) { return { 
            raw_text:gv(d), 
            // action: 'PlaceCard', 
            action:'MoveToSecurity',
            // MoveToSecurity works, PlaceCard doesn't
            choose: 1,
            target: d[1],
    ...
    {"name": "Place$subexpression$5$string$1", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$5", "symbols": ["Place$subexpression$5$string$1"]},
    {"name": "Place$subexpression$5$string$2", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$5", "symbols": ["Place$subexpression$5$string$2"]},
    {"name": "Place$subexpression$5$string$3", "symbols": [{"literal":"P"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$5", "symbols": ["Place$subexpression$5$string$3"]},
    {"name": "Place$subexpression$6", "symbols": ["MultiTarget"]},
    {"name": "Place$subexpression$6", "symbols": ["OtherTarget"]},
    ...
    {"name": "Place$subexpression$8$string$1", "symbols": [{"literal":"'"}, {"literal":"s"}, {"literal":" "}, {"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$8", "symbols": ["Place$subexpression$8$string$1"]},
    {"name": "Place$subexpression$8$string$2", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"s"}, {"literal":" "}, {"literal":"i"}, {"literal":"t"}, {"literal":"s"}, {"literal":" "}, {"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Place", "symbols": ["Place$subexpression$5", "Place$subexpression$6", "Place$ebnf$2", "Place$subexpression$7", "MultiTarget", "Place$subexpression$8", "Place$ebnf$3", "Place$ebnf$4"], "postprocess":  function(d) { 
            let t1 = d[1][0];
            let t2 = d[4];
    ...
    {"name": "Place$string$1", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Place$subexpression$9$string$1", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"s"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$9", "symbols": ["Place$subexpression$9$string$1"]},
    {"name": "Place$subexpression$9$string$2", "symbols": [{"literal":" "}, {"literal":"u"}, {"literal":"n"}, {"literal":"d"}, {"literal":"e"}, {"literal":"r"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$9", "symbols": ["Place$subexpression$9$string$2"]},
    {"name": "Place$subexpression$10$string$1", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"y"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"i"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$10", "symbols": ["Place$subexpression$10$string$1"]},
    {"name": "Place$subexpression$10$string$2", "symbols": [{"literal":"t"}, {"literal":"h"}, {"literal":"a"}, {"literal":"t"}, {"literal":" "}, {"literal":"M"}, {"literal":"o"}, {"literal":"n"}, {"literal":"s"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}, {"literal":" "}, {"literal":"a"}, {"literal":"s"}, {"literal":" "}, {"literal":"i"}, {"literal":"t"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$10", "symbols": ["Place$subexpression$10$string$2"]},
    {"name": "Place$string$2", "symbols": [{"literal":" "}, {"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place", "symbols": ["Place$string$1", "MultiTarget", "Place$ebnf$5", "Place$subexpression$9", "Place$subexpression$10", "Place$string$2"], "postprocess":  function(d) { 
        const that_monster =    {
    ...
    {"name": "Place$subexpression$11$string$1", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$11", "symbols": ["Place$subexpression$11$string$1"]},
    {"name": "Place$subexpression$11$string$2", "symbols": [{"literal":"p"}, {"literal":"l"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$11", "symbols": ["Place$subexpression$11$string$2"]},
    ...
    {"name": "Place$subexpression$12$string$1", "symbols": [{"literal":" "}, {"literal":"u"}, {"literal":"n"}, {"literal":"d"}, {"literal":"e"}, {"literal":"r"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$12", "symbols": ["Place$subexpression$12$string$1"]},
    {"name": "Place$subexpression$12$string$2", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}, {"literal":"b"}, {"literal":"o"}, {"literal":"t"}, {"literal":"t"}, {"literal":"o"}, {"literal":"m"}, {"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"a"}, {"literal":"r"}, {"literal":"d"}, {"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Place$subexpression$12", "symbols": ["Place$subexpression$12$string$2"]},
    {"name": "Place", "symbols": ["Place$subexpression$11", "MultiTarget", "Place$ebnf$6", "Place$subexpression$12", "MultiTarget"], "postprocess":  function(d) { return { 
        raw_text:gv(d),  action: 'PlaceCard', 
        choose: 1,
        target: d[1],
        target2: d[4],
    ...
    {"name": "Trash", "symbols": ["Trash$subexpression$5", "MultiTarget", "Trash$subexpression$6", "MultiTarget", "Trash$ebnf$1"], "postprocess":  function(d,l,r) { 
        ...
        ///   if (! gv(d[1]).includes("card")) return r;  // this hits "security card" too :<
          //  console.error(948, gv(d[1]));
            if (! gv(d[1]).includes("evolution card")) {
        //        console.error("no match " + gv(d[1]) + " doesn't einclude evo card");
                 return r;
            }
            let target = d[3];
        ...
        //    if (! gv(target).match(/^([1-9]+|all )/i)) return r; // require a number to double-target
          //  console.error(950, "OPASS");
            let target2 = d[1];
            target2.targets[0].under = { raw_text: "under it", targetspecial: 'previous' }
        ...
        //    choose: d[8].count,
         //   target: d[8],
           // n: Number(gv(d[4])),
            ...
            // console.error (978, ret);
             return ret;
             } },
    {"name": "Trash$subexpression$7$string$1", "symbols": [{"literal":"t"}, {"literal":"r"}, {"literal":"a"}, {"literal":"s"}, {"literal":"h"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Trash$subexpression$7", "symbols": ["Trash$subexpression$7$string$1"]},
    {"name": "Trash$subexpression$7$string$2", "symbols": [{"literal":"T"}, {"literal":"r"}, {"literal":"a"}, {"literal":"s"}, {"literal":"h"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Trash$subexpression$7", "symbols": ["Trash$subexpression$7$string$2"]},
    {"name": "Trash$subexpression$7$string$3", "symbols": [{"literal":"t"}, {"literal":"r"}, {"literal":"a"}, {"literal":"s"}, {"literal":"h"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Trash", "symbols": ["Trash$subexpression$9", "MultiTarget", "Trash$subexpression$10", "MultiTarget"], "postprocess":  function (d) {  
            ...
            target2: target2,
            //  wtf, what was this possibly matching? d doesn';t have enough! why was this not an error!
            //for_each: gv(d[5]),
            line: 928,
            debug: "help",
    ...
    {"name": "GiveStatus", "symbols": ["GiveStatus$subexpression$1", "MultiTarget", {"literal":" "}, "StatusThingy"], "postprocess": function(d,l) { return { 
           ...d[3],
           raw_text:gv(d),  action: 'give status', 
           target: d[1],
    ...
    {"name": "GiveStatus", "symbols": ["GiveStatus$string$1", "MultiTarget", {"literal":" "}, "Keyword"], "postprocess": function(d,l) { return { 
           raw_text:gv(d),  action: 'give status', 
           target: d[1],
           keyword: gv(d[3]),
           line: 401, 
    ...
    {"name": "GiveStatus", "symbols": ["GiveStatus$string$2", "MultiTarget", "GiveStatus$string$3", "StatusThingy"], "postprocess": function(d,l) { return { 
           ...d[3],
           raw_text:gv(d),
           target: d[1],
           line: 1013,
    ...
    {"name": "Delete", "symbols": ["Delete$subexpression$1", "MultiTarget"], "postprocess":  function(d,l) { return { 
    ...
    {"name": "OtherClause", "symbols": ["OtherClause$string$2"], "postprocess":  function(d ) { return { 
    ...
    {"name": "StackClause", "symbols": ["StackClause$string$1", "EvoCards"], "postprocess":  function(d) { return { 
    ...
    {"name": "StackClause", "symbols": ["Number", "StackClause$string$2", "EvoCards"], "postprocess":  function(d) { return { 
    ...
    {"name": "StackClause", "symbols": ["Number", "StackClause$string$3", "StackClause$subexpression$1", {"literal":" "}, "EvoCards"], "postprocess":  function(d) { return {
    ...
    {"name": "StackClause", "symbols": ["MultiTarget", "StackClause$string$4", "EvoCards"], "postprocess":  function(d) { return {
    ...
    {"name": "StackClause", "symbols": ["StackClause$string$5", "EvoCards", "StackClause$string$6", "StackClause$subexpression$2"], "postprocess":  function(d) { return {
    ...
    {"name": "SuperlativeClause", "symbols": ["SuperlativeClause$ebnf$1", "Superlative", {"literal":" "}, "Property"], "postprocess":  function(d) { 
        return { raw_text:gv(d),  type: 'SuperlativeClause', line: 1108,
    ...
    {"name": "SuperlativeClause", "symbols": ["SuperlativeClause$ebnf$2", "Superlative"], "postprocess":  function(d) { 
        return { raw_text:gv(d),  type: 'SuperlativeClause',  line:1111,
    ...
    {"name": "PostSuperlativeClause", "symbols": ["PostSuperlativeClause$subexpression$1", "Superlative"], "postprocess":  function(d) { 
        return { raw_text:gv(d), type: 'SuperlativeClause', line: 1115,
        superlative: d[1].superlative, count: true }; } },
    ...
    {"name": "CostClause", "symbols": ["CostNoun", "CostClause$string$1", "Number", "CostClause$ebnf$1"], "postprocess":  function(d) { return { 
    ...
    {"name": "CostNoun$subexpression$1$ebnf$1", "symbols": [{"literal":"n"}], "postprocess": id},
    {"name": "CostNoun$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "CostNoun$subexpression$1", "symbols": [{"literal":"a"}, "CostNoun$subexpression$1$ebnf$1"]},
    {"name": "CostNoun$string$5", "symbols": [{"literal":" "}, {"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}, {"literal":" "}, {"literal":"c"}, {"literal":"o"}, {"literal":"s"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "CostNoun", "symbols": ["CostNoun$subexpression$1", "CostNoun$string$5"]},
    {"name": "GroupFeature$subexpression$1$string$1", "symbols": [{"literal":"t"}, {"literal":"o"}, {"literal":"t"}, {"literal":"a"}, {"literal":"l"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$subexpression$1", "symbols": ["GroupFeature$subexpression$1$string$1"]},
    {"name": "GroupFeature$subexpression$1$string$2", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"m"}, {"literal":"b"}, {"literal":"i"}, {"literal":"n"}, {"literal":"e"}, {"literal":"d"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$subexpression$1", "symbols": ["GroupFeature$subexpression$1$string$2"]},
    {"name": "GroupFeature$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"d"}, {"literal":"d"}, {"literal":"s"}, {"literal":" "}, {"literal":"u"}, {"literal":"p"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$1$subexpression$1", "symbols": ["GroupFeature$ebnf$1$subexpression$1$string$1"]},
    {"name": "GroupFeature$ebnf$1$subexpression$1$string$2", "symbols": [{"literal":" "}, {"literal":"i"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$1$subexpression$1", "symbols": ["GroupFeature$ebnf$1$subexpression$1$string$2"]},
    {"name": "GroupFeature$ebnf$1$subexpression$1$string$3", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$1$subexpression$1", "symbols": ["GroupFeature$ebnf$1$subexpression$1$string$3"]},
    {"name": "GroupFeature$ebnf$1", "symbols": ["GroupFeature$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature$ebnf$2$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"e"}, {"literal":"q"}, {"literal":"u"}, {"literal":"a"}, {"literal":"l"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"l"}, {"literal":"e"}, {"literal":"s"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"a"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$2$subexpression$1", "symbols": ["GroupFeature$ebnf$2$subexpression$1$string$1"]},
    {"name": "GroupFeature$ebnf$2$subexpression$1$string$2", "symbols": [{"literal":" "}, {"literal":"l"}, {"literal":"e"}, {"literal":"s"}, {"literal":"s"}, {"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"a"}, {"literal":"n"}, {"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"e"}, {"literal":"q"}, {"literal":"u"}, {"literal":"a"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$2$subexpression$1", "symbols": ["GroupFeature$ebnf$2$subexpression$1$string$2"]},
    {"name": "GroupFeature$ebnf$2", "symbols": ["GroupFeature$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature$ebnf$3$subexpression$1$ebnf$1$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"l"}, {"literal":"e"}, {"literal":"s"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$3$subexpression$1$ebnf$1", "symbols": ["GroupFeature$ebnf$3$subexpression$1$ebnf$1$string$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$3$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature$ebnf$3$subexpression$1", "symbols": [{"literal":" "}, "Number", "GroupFeature$ebnf$3$subexpression$1$ebnf$1"]},
    {"name": "GroupFeature$ebnf$3", "symbols": ["GroupFeature$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$3", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature$ebnf$4$subexpression$1$string$1", "symbols": [{"literal":" "}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$4$subexpression$1$string$2", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"f"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$4$subexpression$1", "symbols": ["GroupFeature$ebnf$4$subexpression$1$string$1", "Property", "GroupFeature$ebnf$4$subexpression$1$string$2", "Target"]},
    {"name": "GroupFeature$ebnf$4", "symbols": ["GroupFeature$ebnf$4$subexpression$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature", "symbols": ["GroupFeature$subexpression$1", "Property", "GroupFeature$ebnf$1", "GroupFeature$ebnf$2", "GroupFeature$ebnf$3", "GroupFeature$ebnf$4"], "postprocess":  function(d) { 
            let property = d[1];
            // assume second property is the same
            return {
            d: d
        }; } },
    {"name": "GroupFeature$string$1", "symbols": [{"literal":"X"}, {"literal":"X"}, {"literal":"X"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}, {"literal":"t"}, {"literal":"a"}, {"literal":"l"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$string$2", "symbols": [{"literal":" "}, {"literal":"a"}, {"literal":"d"}, {"literal":"d"}, {"literal":"s"}, {"literal":" "}, {"literal":"u"}, {"literal":"p"}, {"literal":" "}, {"literal":"t"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$5$subexpression$1$ebnf$1$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"r"}, {"literal":" "}, {"literal":"l"}, {"literal":"e"}, {"literal":"s"}, {"literal":"s"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "GroupFeature$ebnf$5$subexpression$1$ebnf$1", "symbols": ["GroupFeature$ebnf$5$subexpression$1$ebnf$1$string$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$5$subexpression$1$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature$ebnf$5$subexpression$1", "symbols": [{"literal":" "}, "Number", "GroupFeature$ebnf$5$subexpression$1$ebnf$1"]},
    {"name": "GroupFeature$ebnf$5", "symbols": ["GroupFeature$ebnf$5$subexpression$1"], "postprocess": id},
    {"name": "GroupFeature$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "GroupFeature", "symbols": ["GroupFeature$string$1", "Property", "GroupFeature$string$2", "GroupFeature$ebnf$5"]},
    ...
    {"name": "DPClause", "symbols": ["DPClause$string$2", "Object"], "postprocess":  function(data, location) { return { 
    ...
    {"name": "DPClause", "symbols": ["DPClause$string$3", "DPClause$subexpression$3"], "postprocess":  function(d) { return {
    ...
    {"name": "DPClause", "symbols": ["DPClause$string$4", "DPClause$subexpression$4", "DPClause$ebnf$2"], "postprocess":  function(d) { return {
        raw_text:gv(d),  type: 'DP', compare: "IS_AT_MOST", relative: "targetsource-dp" }; } },
    ...
    {"name": "Superlative", "symbols": ["Superlative$subexpression$1"], "postprocess":  function(d) { return { 
    ...
    {"name": "Superlative", "symbols": ["Superlative$subexpression$2"], "postprocess":  function(d) { return { 
    ...
    {"name": "Property$ebnf$1", "symbols": [{"literal":"s"}], "postprocess": id},
    {"name": "Property$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Property", "symbols": ["Property$string$3", "Property$ebnf$1"]},
    ...
    {"name": "Property$ebnf$2", "symbols": [{"literal":"s"}], "postprocess": id},
    {"name": "Property$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Property", "symbols": ["Property$string$4", "Property$ebnf$2"], "postprocess": function(data, location) { return { raw_text:gv(data),  type: 'Field', text: location.source }; }},
    ...
    {"name": "EvoCondition", "symbols": ["EvoCondition$ebnf$1", "EvoCondition$ebnf$2", "Level", "EvoCondition$ebnf$3", "EvoCondition$ebnf$4", "EvoCondition$ebnf$5"], "postprocess":  function(data, location) { 
        // console.error(875, "Data", data);
         //  console.dir(data, {depth: 9});
             ...
             if (data[4]) OR_array.unshift(data[4]);
         const level_cond = [ ];
         if (data[2]) level_cond.push(data[2]);
         if (data[0]) level_cond.push(data[0]);
    ...
    {"name": "EvoCondition", "symbols": ["EvoCondition$ebnf$6", "EvoCondition$ebnf$7", "EvoCondition$ebnf$8", "EvoCondition$ebnf$9", "EvoCondition$ebnf$10", "EvoCondition$subexpression$1", "Level", {"literal":" "}, "Statement"], "postprocess":  function(data, location) { 
        const left_cond = [ ];
        if (data[4]) left_cond.push(data[4]);
        if (data[2]) left_cond.push(data[2]);
        if (data[0]) left_cond.push(data[0]);
    ...
    {"name": "HasString", "symbols": ["HasString$ebnf$3", "HasString$subexpression$5", "HasString$subexpression$6", "HasString$string$6", "HasString$subexpression$7", "HasString$subexpression$8"], "postprocess":  function (data, location) { return { 
    ...
    {"name": "At", "symbols": ["At$string$1", "At$ebnf$1", "At$ebnf$2", "At$string$2", "At$ebnf$3", "At$ebnf$4", "At$ebnf$5", "At$subexpression$1"], "postprocess":  
        function(d, l) { 
            let which = "THIS";
            if (tgv(d[4]) === "your") which = "YOUR";
            if (tgv(d[6]) === "opponent's") which = "OPPONENT";
        ...
        for (let i = 1; i < array.length; i++) {
            ...
            if (Array.isArray(target_and))  {
                if (target_and.some( item => item.such )) {
                    ...
                    let join = [];
                    if (previous.and) join.push(... previous.and);
                    // previous.and was array, previous.with is object :<
                    if (previous.with) join.push(previous.with);
                    array[i].and = join;
                }
            }
        }
    ...
    {"name": "Target", "symbols": ["Adjectives", {"literal":" "}, "Entity", "Target$ebnf$1", "Target$ebnf$2", "Target$ebnf$3", "Target$ebnf$4", "Target$ebnf$5", "Target$ebnf$6", "Target$ebnf$7"], "postprocess":  function(d, l,r) {
        ...
        let with_ = d[5] && d[5][1];
        let under = d[6] && d[6][1];
        if (post) and = and.concat(post[1]); // add post-superlative adjectives
        if (trailer) and = and.concat(trailer); 
        ...
        if (under && under.raw_text.match(/^([1-9]+|all |each )/i)) return r; 
    ...
    {"name": "Target", "symbols": ["Target$subexpression$1"], "postprocess":  function(d, l) {  return { 
    ...
    {"name": "Target", "symbols": ["Target$string$1"], "postprocess":  function(d, l) {  return { 
            raw_text:gv(d), type: 'Target', it: true, 
            and: [ 
                {
                    raw_text: "Monster",
    ...
    {"name": "Article$ebnf$2$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Article$ebnf$2", "symbols": ["Article$ebnf$2$string$1"], "postprocess": id},
    {"name": "Article$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Article", "symbols": ["Article$ebnf$1", "Article$ebnf$2"], "postprocess": function(d, l) { return { raw_text: gv(d), count:gv(d[0]) }; }},
    ...
    {"name": "Article", "symbols": ["Article$string$1", "Article$ebnf$3"], "postprocess": function(d, l) { return { raw_text: gv(d), upto: true, count: gv(d[1]) }; }},
    {"name": "Article$ebnf$4", "symbols": [/[0-9]/]},
    {"name": "Article$ebnf$4", "symbols": ["Article$ebnf$4", /[0-9]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "Article", "symbols": ["Article$ebnf$4", "Article$string$2"], "postprocess": function(d, l) { return { raw_text: gv(d), at_least: true, count: gv(d[1]) }; }},
    ...
    {"name": "Article", "symbols": ["Article$subexpression$2", "Article$ebnf$5"], "postprocess": function(d, l) { return { raw_text: gv(d), count: 999}; }},
    ...
    {"name": "Article$ebnf$6", "symbols": [{"literal":"'"}], "postprocess": id},
    {"name": "Article$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Article", "symbols": ["Article$string$7", "Article$ebnf$6"], "postprocess": function(d, l) { return { raw_text: gv(d)}; }},
    ...
    {"name": "Article$ebnf$7$string$1", "symbols": [{"literal":" "}, {"literal":"n"}, {"literal":"u"}, {"literal":"m"}, {"literal":"b"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Article$ebnf$7", "symbols": ["Article$ebnf$7$string$1"], "postprocess": id},
    {"name": "Article$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Article$ebnf$8$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Article$ebnf$8", "symbols": ["Article$ebnf$8$string$1"], "postprocess": id},
    {"name": "Article$ebnf$8", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Article", "symbols": ["Article$string$11", "Article$ebnf$7", "Article$ebnf$8"], "postprocess": function(d, l) { return { raw_text: gv(d) }; }},
    ...
    {"name": "Article$ebnf$9$string$1", "symbols": [{"literal":" "}, {"literal":"o"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Article$ebnf$9", "symbols": ["Article$ebnf$9$string$1"], "postprocess": id},
    {"name": "Article$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "Article", "symbols": ["Article$string$13", "Article$ebnf$9"], "postprocess": function(d, l) { return { raw_text: gv(d) }; }},
    ...
    {"name": "Article", "symbols": ["Target", "Article$string$16"], "postprocess":  function(d,l,r) {
        ...
        //            if (target.from_txt === "from") return r;
                    if (target_txt.match(/^[1-9] /)) return r; 
                // it's not enough to test here. "1 of (your monster)'s and we don't have it any more.
                    if (target.count > 1) return r; // can't match "2 things' bottom cards" as single multitarget 
    ...
    {"name": "Adjective$string$2", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"c"}, {"literal":"h"}, {"literal":"1"}, {"literal":"1"}, {"literal":"1"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Adjective", "symbols": ["Adjective$string$2"], "postprocess": function(d, l) { return { raw_text: gv(d), such: true }; }},
    {"name": "Adjective$string$3", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"c"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Adjective$string$4", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"s"}, {"literal":"p"}, {"literal":"e"}, {"literal":"n"}, {"literal":"d"}, {"literal":"e"}, {"literal":"d"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Adjective", "symbols": ["Adjective$ebnf$1", "Adjective$string$4"], "postprocess": function(d, l) { return { raw_text: gv(d), suspended: !d[0] }; }},
    {"name": "Adjective$string$5", "symbols": [{"literal":"e"}, {"literal":"v"}, {"literal":"o"}, {"literal":"l"}, {"literal":"u"}, {"literal":"t"}, {"literal":"i"}, {"literal":"o"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Adjective", "symbols": ["Adjective$string$5"], "postprocess": function(d, l) { return { raw_text: gv(d), is_evo_card: true }; }},
    {"name": "Adjective$string$6", "symbols": [{"literal":"l"}, {"literal":"i"}, {"literal":"n"}, {"literal":"k"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Adjective", "symbols": ["Adjective$string$6"], "postprocess": function(d, l) { return { raw_text: gv(d), is_link_card: true }; }},
    {"name": "Adjective$string$7", "symbols": [{"literal":"o"}, {"literal":"t"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Adjective", "symbols": ["Adjective$string$7"], "postprocess": function(d, l) { return { raw_text: gv(d), other: true }; }},
    {"name": "Adjective$string$8", "symbols": [{"literal":"f"}, {"literal":"a"}, {"literal":"c"}, {"literal":"e"}, {"literal":"-"}, {"literal":"u"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "FromRegion", "symbols": ["FromRegion$string$1"], "postprocess":  function(d, l) { return { 
        raw_text: gv(d), or: [
    ...
    {"name": "FromRegion", "symbols": ["FromRegion$subexpression$2", "FromRegion$string$4"], "postprocess":  function(d, l) { return { 
    ...
    {"name": "Location", "symbols": ["Location$string$4"], "postprocess":  function(d, l) { return { 
        raw_text: gv(d), is_evo_card: true, under: { raw_text: "this Monster", self: true },  location: "battle", }; } },
    ...
    {"name": "Location", "symbols": ["Location$string$5"], "postprocess":  function(d,l ) { return { 
         l: l,
    ...
    {"name": "Card", "symbols": ["Card$string$1", "Card$ebnf$1"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
    ...
    {"name": "Card", "symbols": ["Card$string$2", "Card$ebnf$2"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
    ...
    {"name": "Card", "symbols": ["Card$string$3", "Card$ebnf$3"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
        //     { raw_text: "card",  entity: "card" },
    ...
    {"name": "Card", "symbols": ["StandaloneText", "Card$string$5", "Card$ebnf$5"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
    ...
    {"name": "Card", "symbols": ["Card$string$6", "Card$ebnf$6"], "postprocess":  function(d) { return { raw_text:gv(d), entity: gv(d), and: [ 
    ...
    {"name": "Monster", "symbols": ["Monster$subexpression$1", "Monster$ebnf$1"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
    ...
    {"name": "Monster", "symbols": ["Monster$string$2"], "postprocess":  function(d, l) { return { raw_text:gv(d), it: true, entity: gv(d), and: [ 
        // { raw_text: "card",  entity: "entity" },
         { raw_text: "Monster",  entity_type: "Monster" }
         ],  type: 'Entity' }; } },
    ...
    {"name": "Tamer", "symbols": ["Tamer$string$1", "Tamer$ebnf$1"], "postprocess":  function(d, l) { return { raw_text:gv(d), entity: gv(d), and: [ 
        // { raw_text: "card",  entity: "entity" },
         { raw_text: "Tamer",  entity_type: "Tamer" }
         ],  type: 'Entity' }; } },
