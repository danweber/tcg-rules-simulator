...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [
            ...
            { "name": "WhenEvo$string$1", "symbols": [{ "literal": " " }, { "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "v" }, { "literal": "e" }, { "literal": "s" }, { "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "WhenEvo", "symbols": ["Target", "WhenEvo$string$1", "Target"], "postprocess": function (d) { return { raw_text: gv(d), event: "EVOLVE", before: d[0], after: d[2] }; } },
            ...
            { "name": "EffSentence$ebnf$1$subexpression$1$string$1", "symbols": [{ "literal": "W" }, { "literal": "h" }, { "literal": "e" }, { "literal": "n" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "EffSentence$ebnf$1$subexpression$1$string$2", "symbols": [{ "literal": "," }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "EffSentence$ebnf$1$subexpression$1", "symbols": ["EffSentence$ebnf$1$subexpression$1$string$1", "WhenSentence", "EffSentence$ebnf$1$subexpression$1$string$2"] },
            ...
            { "name": "EffSentence$ebnf$2", "symbols": ["IfClause"], "postprocess": id },
            { "name": "EffSentence$ebnf$2", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence$ebnf$3$subexpression$1$string$1", "symbols": [{ "literal": "," }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "EffSentence$ebnf$3$subexpression$1", "symbols": ["Cost", "EffSentence$ebnf$3$subexpression$1$string$1"] },
            { "name": "EffSentence$ebnf$3", "symbols": ["EffSentence$ebnf$3$subexpression$1"], "postprocess": id },
            ...
            { "name": "EffSentence$ebnf$4", "symbols": [{ "literal": "." }], "postprocess": id },
            { "name": "EffSentence$ebnf$4", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["EffSentence$ebnf$1", "EffSentence$ebnf$2", "EffSentence$ebnf$3", "EffSentence$subexpression$1", "EffSentence$ebnf$4"], "postprocess": function (d, l) {
                    ...
                    return { raw_text: gv(d), when_s: tgv(d[0]), if: tgv(d[1]), cost: tgv(d[2]), type: 'EffSentence', effect: d[3][0] };
                } },
            { "name": "EffSentence$ebnf$5", "symbols": [{ "literal": "," }], "postprocess": id },
            { "name": "EffSentence$ebnf$5", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["Cost", "EffSentence$ebnf$5"] },
            ...
            { "name": "SpecialCase", "symbols": ["SpecialCase$string$1", "NestedEffect"], "postprocess": function (d, l) {
                    return { raw_text: gv(d), type: 'Action', action: 'Delay', nested_solid: d[1].nested_solid,
                        nested_solid_s: d[1].nested_solid_s };
                } },
            { "name": "NestedEffect", "symbols": [{ "literal": "・" }, "EffSentence"], "postprocess": function (d, l) {
            ...
            { "name": "Return$string$2", "symbols": [{ "literal": " " }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }, { "literal": "b" }, { "literal": "o" }, { "literal": "t" }, { "literal": "t" }, { "literal": "o" }, { "literal": "m" }, { "literal": " " }, { "literal": "o" }, { "literal": "f" }, { "literal": " " }, { "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }, { "literal": "d" }, { "literal": "e" }, { "literal": "c" }, { "literal": "k" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Return", "symbols": ["Return$string$1", "MultiTarget", "Return$string$2"], "postprocess": function (d, l) { return { raw_text: gv(d), action: 'bottomdeck', target: d[1] }; } },
            ...
            { "name": "Evolve$string$1", "symbols": [{ "literal": "e" }, { "literal": "v" }, { "literal": "o" }, { "literal": "l" }, { "literal": "v" }, { "literal": "i" }, { "literal": "n" }, { "literal": "g" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Evolve$string$2", "symbols": [{ "literal": " " }, { "literal": "i" }, { "literal": "n" }, { "literal": "t" }, { "literal": "o" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Evolve$ebnf$1", "symbols": ["ForFree"], "postprocess": id },
            { "name": "Evolve$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Evolve", "symbols": ["Evolve$string$1", "MultiTarget", "Evolve$string$2", "MultiTarget", "Evolve$ebnf$1"] },
            ...
            { "name": "Article$string$8", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": "i" }, { "literal": "r" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Article", "symbols": ["Article$string$8"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            { "name": "Article$string$9", "symbols": [{ "literal": "a" }, { "literal": "n" }, { "literal": "y" }], "postprocess": function joiner(d) { return d.join(''); } },
            ...
            { "name": "Article$string$11", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "a" }, { "literal": "t" }], "postprocess": function joiner(d) { return d.join(''); } },
            ...
            { "name": "Adjective", "symbols": ["TraitClause"], "postprocess": function (d, l) { return { raw_text: gv(d) }; } },
            ...
            { "name": "FromRegion", "symbols": ["FromRegion$string$4"], "postprocess": function (d, l) { return { raw_text: gv(d), location: "field" }; } },
            ...
            { "name": "Entity", "symbols": ["Tamer"], "postprocess": function (d, l) { return { raw_text: gv(d), entity: d[0].entity, type: 'Entity' }; } },
            { "name": "Entity", "symbols": ["Option"], "postprocess": function (d, l) { return { raw_text: gv(d), entity: d[0].entity, type: 'Entity' }; } },
            ...
            { "name": "Entity", "symbols": ["Entity", "Entity$string$1", "Entity"] },
            ...
            { "name": "Tamer", "symbols": ["Tamer$string$1", "Tamer$ebnf$1"] },
