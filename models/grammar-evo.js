...
(function () {
    ...
    var grammar = {
        ...
        ParserRules: [
            ...
            { "name": "WhenSentence", "symbols": ["WhenEvo"], "postprocess": function (d) { return { type: 'WhenSentence', When: d[0] }; } },
            ...
            { "name": "EffSentence$ebnf$1", "symbols": [{ "literal": "." }], "postprocess": id },
            { "name": "EffSentence$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["Declarative", "EffSentence$ebnf$1"] },
            ...
            { "name": "EffSentence$ebnf$3", "symbols": [{ "literal": "." }], "postprocess": id },
            { "name": "EffSentence$ebnf$3", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["EffSentence$ebnf$2", "Imperative", "EffSentence$ebnf$3"], "postprocess": function (d, l) {
            ...
            { "name": "EffSentence", "symbols": ["Cost", "EffSentence$ebnf$4"] },
            { "name": "EffSentence$ebnf$5", "symbols": [{ "literal": "." }], "postprocess": id },
            { "name": "EffSentence$ebnf$5", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "EffSentence", "symbols": ["YouDeclare", "EffSentence$ebnf$5"], "postprocess": function (d, l) {
                    return { raw_text: gv(d), type: 'EffSentence', effect: d[0] };
                } },
            ...
            { "name": "Play$ebnf$1$string$1", "symbols": [{ "literal": " " }, { "literal": "w" }, { "literal": "i" }, { "literal": "t" }, { "literal": "h" }, { "literal": "o" }, { "literal": "u" }, { "literal": "t" }, { "literal": " " }, { "literal": "p" }, { "literal": "a" }, { "literal": "y" }, { "literal": "i" }, { "literal": "n" }, { "literal": "g" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Play$ebnf$1", "symbols": ["Play$ebnf$1$string$1"], "postprocess": id },
            { "name": "Play$ebnf$1", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play$ebnf$2$string$1", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Play$ebnf$2", "symbols": ["Play$ebnf$2$string$1"], "postprocess": id },
            { "name": "Play$ebnf$2", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play$ebnf$3$string$1", "symbols": [{ "literal": "t" }, { "literal": "h" }, { "literal": "e" }, { "literal": "i" }, { "literal": "r" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Play$ebnf$3", "symbols": ["Play$ebnf$3$string$1"], "postprocess": id },
            { "name": "Play$ebnf$3", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play$ebnf$4$string$1", "symbols": [{ "literal": "m" }, { "literal": "e" }, { "literal": "m" }, { "literal": "o" }, { "literal": "r" }, { "literal": "y" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Play$ebnf$4", "symbols": ["Play$ebnf$4$string$1"], "postprocess": id },
            { "name": "Play$ebnf$4", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play$ebnf$5$string$1", "symbols": [{ "literal": "c" }, { "literal": "o" }, { "literal": "s" }, { "literal": "t" }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Play$ebnf$5", "symbols": ["Play$ebnf$5$string$1"], "postprocess": id },
            { "name": "Play$ebnf$5", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play$ebnf$6", "symbols": [{ "literal": "s" }], "postprocess": id },
            { "name": "Play$ebnf$6", "symbols": [], "postprocess": function (d) { return null; } },
            { "name": "Play", "symbols": ["Play$subexpression$1", "MultiTarget", "Play$ebnf$1", "Play$ebnf$2", "Play$ebnf$3", "Play$ebnf$4", "Play$ebnf$5", "Play$ebnf$6"], "postprocess": function (d, l) { return { raw_text: gv(d), action: 'play', target: d[1], no_cost: !!d[2] }; } },
            ...
            { "name": "Cost$string$1", "symbols": [{ "literal": "B" }, { "literal": "y" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
            { "name": "Cost", "symbols": ["Cost$string$1", "Imperative"] },
            ...
            { "name": "Delete$subexpression$1$string$2", "symbols": [{ "literal": "d" }, { "literal": "e" }, { "literal": "l" }, { "literal": "e" }, { "literal": "t" }, { "literal": "i" }, { "literal": "n" }, { "literal": "g" }, { "literal": " " }], "postprocess": function joiner(d) { return d.join(''); } },
