...
export class MultiTargetDesc {
    ...
    toPlainText(): string { return this.parse_matches ? JSON.stringify(this.parse_matches) : 
        this.targets.map(t => t.toPlainText()).join(" _and_ "); }
    toString(): string { return  this.parse_matches ? JSON.stringify(this.parse_matches) : 
    ...
    constructor(text: string) {
        ...
        if (!text.includes("1 your")) {// skip this for stack summons for now
            ...
            // console.log("xxx " + text); console.dir(grammared, {depth: null} );
            if (grammared) {
