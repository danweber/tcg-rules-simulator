...
if (true) {
  ...
  let visible = `<p>New home: <a href="https://tcg-rules-sim.azurewebsites.net/">here</a>
  dev server for tests: <a href="https://tcg-rules-sim-dev.azurewebsites.net/">here</a> 
</p> `;
  let invisible = ``;
  ...
  app.get('/', function (req, res, next) {
    ...
    let announce = visible;
    const url = req.protocol + '://' + req.get('host') + req.originalUrl;
    if (url.includes('tcg-rules-test')) {
      announce = invisible;
    }
    res.render('index', { title: 'Rule Simulator v0.8.71', word: word, announce: announce, text: url });
