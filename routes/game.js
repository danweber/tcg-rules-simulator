...
# Monsters on field are space-separated.

# Each Monster is comma-separated field.
...
P1:CrazyStack,DW1-08,DW1-07,DW1-06,DW1-05,DW1-04,DW1-03,DW1-02,DW1-01
HAND1:ST15-17

P2:Vaxxy,DW1-YellowVax
HAND2:ST16-17
...
router.post('/init_game', (req, res) => {
  ...
  let bot1 = req.body.bot1;
  let bot2 = req.body.bot2;
  ...
  while (true) {
    ...
    if (!game_list[gid]) {
      ...
      let game = new Game(mastergame, gid, [], p1string, p2string, bot1, bot2);
      game_list[gid] = game;
